ALTER VIEW Cart_Total_Discount AS
SELECT
    added.cart_number,
    added.locked_number,
        ...
        THEN 
            CASE
                ...
                ELSE 
                    ...
                    CASE 
                        WHEN dc.amount < dc.dis_limit THEN dc.amount
                        ELSE dc.dis_limit 
                    END
            END
        ELSE 0
...
FROM
    added_to added
JOIN
    product p ON added.product_id = p.id
LEFT JOIN
    applied_to ap ON added.cart_number = ap.cart_number 
    AND added.locked_number = ap.locked_number
LEFT JOIN
    discount_code dc ON ap.app_code = dc.dis_code  
JOIN 
